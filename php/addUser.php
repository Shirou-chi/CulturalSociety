...
<body>
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="card border-0">
                        ...
                        <form action="#" method="post" class="container" id="addUser">
                            ...
                            <div class="card-body">
                                ...
                                <div class="right">
                                    <div class="upper">
                                        ...
                                        <input type="submit" id="addAdminBtn" value="ADD USER">
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addUser.addEventListener('submit', function(user) {
                user.preventDefault(); // Prevent the form from submitting

                // Validate the form inputs
                const username = addUser.querySelector('input[name="username"]');
                const pass = addUser.querySelector('input[name="password"]');
                const email = addUser.querySelector('input[name="email"]');

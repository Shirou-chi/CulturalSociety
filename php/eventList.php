                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <button class="control" type="button" data-toggle="modal" data-target="#exampleModal" onclick="window.location.href='/Assignment/php/editEvent.php?event_id=<?php echo $row['event_id']; ?>'">
                          <ion-icon name="create-outline"></ion-icon>
                          </a>
                        </button>
                        <button class="control" type="button" data-toggle="modal" data-target="#exampleModal" onclick="window.location.href='/Assignment/php/eventList.php?event_id=<?php echo $row['event_id']; ?>'">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <div class="container d-flex pl-0">
            <h5 class="modal-title ml-2" id="exampleModalLabel">Delete the event?</h5>
          </div>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="window.location.href='eventList.php'">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-light" onclick="window.location.href='eventList.php'">Cancel</button>
          <button type="button" class="btn btn-danger" onclick="window.location.href='dltEvent.php?event_id=<?php echo $_GET['event_id']; ?>'">Delete</button>
        </div>
      </div>
    </div>
    </div>
